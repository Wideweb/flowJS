...
export default class AnimationManager {
    ...
    setAnimation(actionType: ActionType): void {
        const newAnimation = this.animationMap.get(actionType);
    ...
    load(container: Container): void {
        ...
        this.animationMap.set(ActionType.Ready, attack);
        this.animationMap.set(ActionType.Steady, attack);
        this.animationMap.set(ActionType.SlowDown, attack);
    }
